...
public class DeliveryInfoRequestDto {
    ...
    public static class DeliveryInfoRequestDtoBuilder {
        ...
        public String toString() {
            return "DeliveryInfoRequestcom.example.my_demo.dto.DeliveryInfoRequestDtoBuilder(deliveryWeight=" + this.deliveryWeight + ", localitySandID=" + this.localitySandID + ", localityGetID=" + this.localityGetID + ")";
        }
    }
}
