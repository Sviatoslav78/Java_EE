...
public class BillInfoToPayDto {
    ...
    public static class BillInfoToPayDtoBuilder {
        ...
        public String toString() {
            return "BillInfoToPaycom.example.my_demo.dto.BillInfoToPayDtoBuilder(billId=" + this.billId + ", price=" + this.price + ", deliveryId=" + this.deliveryId + ", weight=" + this.weight + ", addreeserEmail=" + this.addreeseeEmail + ", localitySandName=" + this.localitySandName + ", localityGetName=" + this.localityGetName + ")";
        }
    }
}
